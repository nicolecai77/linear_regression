...
ylim = y limit facet\_wrap =multiple panels
...
This is more exploratory but maybe easier to understand nes= create
table map=apply a function to each element
...
let’s nest even more.. nest(data=-) -exclude the varibales
